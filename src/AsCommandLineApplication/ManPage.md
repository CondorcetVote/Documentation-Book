...
Options:
  ...
  -w, --votes=VOTES                                                        Votes list file path or direct input
      --import-condorcet-election-format=IMPORT-CONDORCET-ELECTION-FORMAT  File path. Setup an election and his data from a Condorcet Election file as defined as standard on https://github.com/CondorcetPHP/CondorcetElectionFormat . Other parameters from the command line argument have the priority if set. Other votes can be added with the --vote argument, other candidates can't be added.
