...
?> [`CondorcetElectionFormat::exportElectionToCondorcetElectionFormat()`](/Docs/MethodsReferences/Tools_Converters_CondorcetElectionFormat%20Class/public%20static%20Tools_Converters_CondorcetElectionFormat--exportElectionToCondorcetElectionFormat) 
```php
