...
Following example, take Debian Election leader 2021 file as example ( https://www.debian.org/vote/2021/vote_001 )
```shell
condorcet election --import-condorcet-election-format=tallyFiles/D21.debian_votes -sr SchulzeMargin
